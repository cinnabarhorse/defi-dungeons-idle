 ...
 *
 * Client Items Data - Generated from /data/items.ts
 * This file contains item definitions for UI and gameplay.
 *
 * To make changes, edit /data/items.ts and run: npm run generate:shared
 */
