...
const ENEMY_DATA_BASE: Record<string, ServerEnemyStats> = {
  rekt_doggo: {
...
export const ENEMY_DATA: Record<string, ServerEnemyStats> =
  addLickquidatorTags(ENEMY_DATA_BASE);
...
const CLIENT_ENEMY_TYPES_BASE: Record<string, ClientEnemyInfo> = {
  rekt_doggo: {
    enemyType: 'rekt_doggo',
    name: 'RektDoggo',
    deathSound: 'dogbark',
...
export const CLIENT_ENEMY_TYPES: Record<string, ClientEnemyInfo> =
  addLickquidatorTags(CLIENT_ENEMY_TYPES_BASE);
