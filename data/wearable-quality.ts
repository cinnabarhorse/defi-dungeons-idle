...
export function durabilityCapForQuality(
  ...
  const normalized = normalizeQualityTier(quality as QualityTier | null | undefined);
...
export function getRepairCostForDurability(input: {
  ...
  const quality = normalizeQualityTier(input.quality as QualityTier | null | undefined);
